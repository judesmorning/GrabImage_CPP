...
bool CRacerAreaCtrl::PrepareGrab()
{
	...
	catch(...)
	{
		...
		gLogFile.AddCameraRecord(m_nCamIndex, _T("CRacerAreaCtrl::PrepareGrab函数异常"));
	}
...
bool CRacerAreaCtrl::StartGrab()
{
	...
	catch (GenICam::GenericException& e)
	{
		...
		CString strLog;
		strLog.Format(_T("CRacerAreaCtrl::StartGrab异常, 错误原因:%s"), string2wstring(e.what()).c_str());
...
bool CRacerAreaCtrl::StopGrab()
{
	...
	catch (GenICam::GenericException& e)
	{
		...
		CString strLog;
		strLog.Format(_T("CRacerAreaCtrl::StopGrab异常, 错误原因:%s"), string2wstring(e.what()).c_str());
		gLogFile.AddCameraRecord(m_nCamIndex, strLog);
	}
...
void CRacerAreaCtrl::SetCamTrigger(int nParam)
{
	...
	{
		CString strLog;
		strLog.Format(_T("CRacerAreaCtrl::SetCamTrigger异常, 错误原因:%s"), string2wstring(e.what()).c_str());
		gLogFile.AddCameraRecord(m_nCamIndex, strLog);
	}
}
...
void CRacerAreaCtrl::SetCamExposure(int nParam)
{
	...
	{
		CString strLog;
		strLog.Format(_T("CRacerAreaCtrl::SetCamExposure异常, 错误原因:%s"), string2wstring(e.what()).c_str());
		gLogFile.AddCameraRecord(m_nCamIndex, strLog);
	}
}
...
void CRacerAreaCtrl::SetCamGain(int nParam)
{
	...
	{
		CString strLog;
		strLog.Format(_T("CRacerAreaCtrl::SetCamGain异常, 错误原因:%s"), string2wstring(e.what()).c_str());
		gLogFile.AddCameraRecord(m_nCamIndex, strLog);
	}
}
...
void CRacerAreaCtrl::SetCamGrabSize(int nWidth, int nHeight)
{
	...
	{
	     CString strLog;
		 strLog.Format(_T("CRacerAreaCtrl::SetCamGrabSize异常, 错误原因:%s"), string2wstring(e.what()).c_str());
         gLogFile.AddCameraRecord(m_nCamIndex, strLog);
	}
}
