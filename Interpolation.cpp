...
//
//////////////////////////////////////////////////////////////////////
CInterpolation::CInterpolation(double *ctrlPtX,double *ctrlPtY,int nCtrlPtCount)
{
	InitParam();
...
//////////////////////////////////////////////////////////////////////////
bool CInterpolation::GetInterpolationPts(int outPtCount, double *outPtX, double *outPtY)
{
	if (!m_bCreate)
	{
		return m_bCreate;
...
void CInterpolation::InitParam()
{
	X = Y = Z = F = A = B = C = D = H = NULL;
	N = 0;
	M = 0;
}
void CInterpolation::ReleaseMem()
{
	delete [] X;
	delete [] Y;
	//  delete [] Z;
...
bool CInterpolation::InterPolation()
{
...
bool CInterpolation::GetYByX(const double &dbInX, double &dbOutY)
{
	if (!m_bCreate)
	{
		return m_bCreate;
